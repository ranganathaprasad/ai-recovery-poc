...
cv_scores = cross_val_score(
    XGBRegressor(n_estimators=200, learning_rate=0.05, max_depth=5, random_state=42),
...
# ===============================
joblib.dump(model,           model_path("pain_model.pkl"))
joblib.dump(feature_columns, model_path("pain_features.pkl"))
joblib.dump(float(test_mae), model_path("pain_mae.pkl"))
joblib.dump(model_low,       model_path("pain_q_low.pkl"))
joblib.dump(model_high,      model_path("pain_q_high.pkl"))

with open(model_path("pain_eval.json"), "w") as f:
    json.dump(eval_results, f, indent=2)

print(f"\nPain model saved to models/")
