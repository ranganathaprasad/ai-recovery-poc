...
# ===============================
joblib.dump(model,           model_path("rom_model.pkl"))
joblib.dump(feature_columns, model_path("rom_features.pkl"))
joblib.dump(float(test_mae), model_path("rom_mae.pkl"))
joblib.dump(model_low,       model_path("rom_q_low.pkl"))
joblib.dump(model_high,      model_path("rom_q_high.pkl"))

with open(model_path("rom_eval.json"), "w") as f:
    json.dump(eval_results, f, indent=2)

print(f"\nROM model saved to models/")
